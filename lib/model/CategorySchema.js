...
var CategorySchema = function( options ){
  var Schema = options.db.Schema;

  var CategorySchema = new Schema({
    'hash': { type: Number, required: 'The hash is required.' },
    'container_id': { type: Schema.Types.ObjectId, required: 'The container id is required.' },
    'app_id': { type: Schema.Types.ObjectId, required: 'The app id is required.' },
